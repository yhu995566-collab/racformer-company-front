...
# 3DH-Query long-range stage-1 experiment: current + 3 radar/image sweeps.
# The lateral ROI remains the currently validated +/-20m corridor. Update only
# point_cloud_range/grid_config when the full sensor FOV is confirmed.
num_frames = 4
num_cams = 1
